...
X_set, y_set = train['features'], train['labels']
#Normalize????

# TODO: Split data into training and validation sets.
X_train, X_valid, y_train, y_valid = train_test_split(X_set, y_set, test_size=0.33, random_state=0)
...
def evaluate_on_data(X_data, y_data, sess): 
...
with tf.Session() as sess:
    ...
    for i in range(EPOCHS):
        ...
        val_loss, val_acc = evaluate_on_data(X_valid, y_valid, sess)     
